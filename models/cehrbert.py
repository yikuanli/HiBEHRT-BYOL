...
class CEHRBEHRT2Vec(pl.LightningModule):
    def __init__(self, params):
        ...
        self.feature_extractor = CEHRBEHRT(params)
...
class CEHRBEHRT(nn.Module):
    def __init__(self, params):
        super(CEHRBEHRT, self).__init__()
...
class Embedding(nn.Module):
    ...
    def forward(self, word_ids, age_ids, seg_ids, posi_ids):
        ...
        embeddings = self.tanh(self.transform(torch.cat([word_embed, age_embed, posi_embeddings], dim=-1)))
