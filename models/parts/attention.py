...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, encounter):
        ...
        query_layer = self.transpose_for_scores(mixed_query_layer, encounter)
        key_layer = self.transpose_for_scores(mixed_key_layer, encounter)
        value_layer = self.transpose_for_scores(mixed_value_layer, encounter)
